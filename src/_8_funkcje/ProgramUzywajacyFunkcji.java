...
public class ProgramUzywajacyFunkcji {
    public static void main(String[] args) {
        ...
        double poleKola = FunkcjeGeometryczne.poleKoła(x);
        System.out.println("Pole koła: " + poleKola);

        System.out.println("A teraz wylosuję liczbę");
       ...
       // double poleKola2 = Math.PI * losowa * losowa ;
        System.out.println("Pole koła losowa: " + FunkcjeGeometryczne.poleKoła(losowa));
